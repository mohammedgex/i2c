...
class AllFreshCourseListview extends StatelessWidget {
  const AllFreshCourseListview({super.key});
        ...
        child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                verticalGap(5.sp),
                Obx(() {
                  if (freshCourseConroller.isLoading.value) {
                    return Expanded(
                    ...
                    return Expanded(
                      child: ListView.builder(
                          itemCount: freshCourseConroller.courses.length,
                          itemBuilder: (context, index) {
                            return Bounceable(
                              onTap: () {
